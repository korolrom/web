\ipiitem{atom\_f}{The force (x,y,z) acting on a particle given its index. Takes arguments index
                      and bead (both zero based). If bead is not specified, refers to the centroid.}{dimension: force; size: 3; }\ipiitem{atom\_f\_path}{The forces acting on all the beads of a particle given its index. Takes arguments index
                       and bead (both zero based). If bead is not specified, refers to the centroid.}{dimension: length; }\ipiitem{atom\_p}{The momentum (x,y,z) of a particle given its index. Takes arguments index
                      and bead (both zero based). If bead is not specified, refers to the centroid.}{dimension: momentum; size: 3; }\ipiitem{atom\_v}{The velocity (x,y,z) of a particle given its index. Takes arguments index
                       ...
                       and bead (both zero based). If bead is not specified, refers to the centroid.}{dimension: length; size: 3; }\ipiitem{atom\_x\_path}{The positions of all the beads of a particle given its index. Takes arguments index
                       and bead (both zero based). If bead is not specified, refers to the centroid.}{dimension: length; }\ipiitem{bweights\_component}{The weight associated one part of the hamiltonian. Takes one mandatory
                         argument index (zero-based) that indicates for which component of the hamiltonian the weight must be returned. }{dimension: ; }\ipiitem{cell\_abcABC}{The lengths of the cell vectors and the angles between them in degrees as a list of the
                      ...
                      exp(-U(u)) for each frame.}{}\ipiitem{ensemble\_bias}{The bias applied to the current ensemble}{dimension: energy; }\ipiitem{ensemble\_pressure}{The target pressure for the current ensemble}{dimension: pressure; }\ipiitem{ensemble\_temperature}{The target temperature for the current ensemble}{dimension: temperature; }\ipiitem{forcemod}{The modulus of the force. With the optional argument 'bead'
                       will print the force associated with the specified bead.}{dimension: force; }\ipiitem{hweights\_component}{The weight associated one part of the hamiltonian. Takes one mandatory
                         argument index (zero-based) that indicates for which component of the hamiltonian the weight must be returned. }{dimension: ; }\ipiitem{isotope\_scfep}{Returns the (many) terms needed to compute the scaled-coordinates free energy
                      ...
                      of excess potential energy $<$exp(-beta*sc)$>$}{size: 3; }\ipiitem{isotope\_zetasc\_4th}{Returns the (many) terms needed to compute the scaled-coordinates
                          ...
                          $<$exp(-beta*sc)$>$, and 4-5) Suzuki-Chin and Takahashi-Imada 4th-order reweighing term}{size: 5; }\ipiitem{isotope\_zetatd}{Returns the (many) terms needed to directly compute the relative probablity of
                      ...
                      of excess spring energy $<$exp(-beta*spr)$>$}{size: 3; }\ipiitem{isotope\_zetatd\_4th}{Returns the (many) terms needed to compute the thermodynamic
                          ...
                          and Takahashi-Imada 4th-order reweighing term}{size: 5; }\ipiitem{kcv\_scaledcoords}{Returns the estimators that are required to evaluate the scaled-coordinates estimators
                       ...
                       which defaults to -0.0001. If the value of 'fd\_delta' is negative,
                       then its magnitude will be reduced automatically by the code if the finite difference error
                       becomes too large.}{size: 2; }\ipiitem{kinetic\_cv}{The centroid-virial quantum kinetic energy of the physical system.
                      ...
                      Returns the 6 independent components in the form $[$xx, yy, zz, xy, xz, yz$]$. Takes arguments 'i' and 'j',
                       ...
                       or normal mode. If not specified, all atoms/beads/nm are used.}{dimension: energy; }\ipiitem{kinetic\_opsc}{The centroid-virial quantum kinetic energy of the physical system.
                      Takes an argument 'atom', which can be either an atom label or index (zero based)
                      to specify which species to find the kinetic energy of. If not specified, all atoms are used.}{dimension: energy; }\ipiitem{kinetic\_prsc}{The Suzuki-Chin primitive estimator of the quantum kinetic energy of the physical system}{dimension: energy; }\ipiitem{kinetic\_td}{The primitive quantum kinetic energy of the physical system.
                      Takes an argument 'atom', which can be either an atom label or index (zero based)
                      to specify which species to find the kinetic energy of. If not specified, all atoms are used.}{dimension: energy; }\ipiitem{kinetic\_tdsc}{The Suzuki-Chin centroid-virial thermodynamic estimator of the quantum
                      ...
                      of. If not specified, all atoms are used.}{dimension: energy; }\ipiitem{kinetic\_tens}{The centroid-virial quantum kinetic energy tensor of the physical system.
                      ...
                      independent components in the form $[$xx, yy, zz, xy, xz, yz$]$.}{dimension: pressure; size: 6; }\ipiitem{kstress\_tdsc}{The Suzuki-Chin thermodynamic estimator for pressure of the physical system.}{dimension: pressure; }\ipiitem{pot\_component}{The contribution to the system potential from one of the force components.
                       ...
                       with the specified bead. If the potential is weighed, the weight will be applied. }{dimension: energy; }\ipiitem{pot\_component\_raw}{The contribution to the system potential from one of the
                       ...
                       will not be applied. }{dimension: energy; }\ipiitem{potential}{The physical system potential energy. With the optional argument 'bead'
                         will print the potential associated with the specified bead.}{dimension: energy; }\ipiitem{potential\_opsc}{The Suzuki-Chin operator estimator for the potential energy of the physical system.}{dimension: energy; }\ipiitem{potential\_tdsc}{The Suzuki-chin thermodyanmic estimator for the potential energy of the physical system.}{dimension: energy; }\ipiitem{pressure\_cv}{The quantum estimator for pressure of the physical system.}{dimension: pressure; }\ipiitem{pressure\_md}{The pressure of the (extended) classical system.}{dimension: pressure; }\ipiitem{pressure\_tdsc}{The Suzuki-Chin thermodynamic estimator for pressure of the physical system.}{dimension: pressure; }\ipiitem{r\_gyration}{The average radius of gyration of the selected ring polymers. Takes an
                      argument 'atom', which can be either an atom label or index (zero based) to specify which
                      species to find the radius of gyration of. If not specified, all atoms are used and averaged.}{dimension: length; }\ipiitem{sc\_scaledcoords}{Returns the estimators that are required to evaluate the scaled-coordinates estimators
                       for total energy and heat capacity, as described in T. M. Yamamoto,
                       J. Chem. Phys., 104101, 123 (2005). Returns eps\_v and eps\_v', as defined in that paper.
                       As the two estimators have a different dimensions, this can only be output in atomic units.
                       Takes one argument, 'fd\_delta', which gives the value of the finite difference parameter used -
                       which defaults to -0.0001. If the value of 'fd\_delta' is negative,
                       then its magnitude will be reduced automatically by the code if the finite difference error
                       becomes too large.}{size: 2; }\ipiitem{scaledcoords}{Returns the estimators that are required to evaluate the scaled-coordinates estimators
                       for total energy and heat capacity, as described in T. M. Yamamoto,
                       J. Chem. Phys., 104101, 123 (2005). Returns eps\_v and eps\_v', as defined in that paper.
                       As the two estimators have a different dimensions, this can only be output in atomic units.
                       Takes one argument, 'fd\_delta', which gives the value of the finite difference parameter used -
                      ...
                      independent components in the form $[$xx, yy, zz, xy, xz, yz$]$.}{dimension: pressure; size: 6; }\ipiitem{temperature}{The current temperature, as obtained from the MD kinetic energy of the (extended)
                             ...
                             all atoms are used.}{dimension: energy; size: 1; }\ipiitem{ti\_weight}{The 3 numbers output are 1) the logarithm of the weighting factor -beta\_P delta H,
                      2) the square of the logarithm, and 3) the weighting factor}{size: 3; }\ipiitem{time}{The elapsed simulation time.}{dimension: time; }\ipiitem{vcom}{The center of mass velocity (x,y,z) of the system or of a species. Takes arguments label
                       (default to all species) and bead (zero based). If bead is not specified, refers to the centroid.}{dimension: velocity; size: 3; }\ipiitem{vir\_tdsc}{The Suzuki-Chin thermodynamic estimator for pressure of the physical system.}{dimension: pressure; }\ipiitem{virial\_cv}{The quantum estimator for the virial stress tensor of the physical system.
                      Returns the 6 independent components in the form $[$xx, yy, zz, xy, xz, yz$]$.}{dimension: pressure; size: 6; }\ipiitem{virial\_fq}{Returns the scalar product of force and positions. Useful to compensate for 
                          the harmonic component of a potential. Gets one argument 'ref' that should be a filename for a 
                          reference configuration, in the style of the FFDebye geometry input, and one that contains the input units.}{dimension: energy; size: 1; }\ipiitem{virial\_md}{The virial tensor of the (extended) classical system. Returns the 6
